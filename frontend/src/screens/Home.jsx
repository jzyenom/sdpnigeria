                    ...
                    <div className="flex flex-grow lg:w-3/4 xl:w-4/5">
                      <div className="w-full lg:px-6 lg:w-3/4 xl:px-12">
                        <div className="relative">
                          <input
                            id="docsearch"
                            className="transition-colors duration-100 ease-in-out bg-white shadow-md focus:outline-0 border border-transparent placeholder-gray-600 rounded-lg py-2 pr-4 pl-10 block w-full appearance-none leading-normal"
                            type="text"
                      ...
                      <button
                        type="button"
                        id="sidebar-open"
                        className="text-gray-500 focus:outline-none focus:text-gray-700 flex px-6 items-center lg:hidden"
                      >
                        <svg
                      ...
                      <button
                        type="button"
                        id="sidebar-close"
                        className="text-gray-500 focus:outline-none focus:text-gray-700 hidden flex px-6 items-center lg:hidden"
                      >
                        <svg
                          className="fill-current w-4 h-4"
                          xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="w-full max-w-screen-xl relative mx-auto px-6 pt-16 pb-40 md:pb-24">
              <div className="xl:flex -mx-6">
                ...
                <div className="mt-12 xl:mt-0 px-6 flex-shrink-0 hidden md:block">
                  <iframe
                    src="workflow-animation/index.html"
